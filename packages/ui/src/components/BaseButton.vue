...
<template>
    <button
        ...
        :class="[
            ...
            variant === 'outline' &&
                'border border-gray-300 bg-transparent text-gray-700 hover:bg-gray-50 focus:ring-gray-500 disabled:border-gray-200 disabled:text-gray-400',
    ...
    >
        <iconify-icon v-if="loading" icon="fa7-solid:spinner" class="h-4 w-4 animate-spin text-current"></iconify-icon>
